...
export class LivroRepository {
    ...
    async insertLivro(
      ...
      categoriaId: number
        ...
        try{
            ...
            const newLivro = new Livro(isbn, titulo, autor, editora, edicao, categoriaId, resultado.insertId);
    ...
    async buscarLivroPorAutorEditoraEdicao(autor: string, editora: string, edicao: string ): Promise <Livro[]> {
        try{
    ...
    async atualizarDadosLivro(livro: Livro): Promise<Livro | undefined>{
        ...
        try { 
            const resultado: any = await executarComandoSQL(query, params);
